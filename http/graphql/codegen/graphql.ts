...
export type StockColumnFragmentFragment = { __typename?: 'StockColumn', stockCount: string, leadTime?: number | null, leftDate: number, monthSaleCount: number, productName: string, wonPrice?: number | null } & { ' $fragmentName'?: 'StockColumnFragmentFragment' };

export type ProductOrderFragmentFragment = { __typename?: 'ProductOrder', _id: string, payCost: number, notPayCost: number, totalPayCost: number, isDone: boolean, createdAt: any, factory: { __typename?: 'Factory', _id: string, name: string }, products: Array<{ __typename?: 'OrderProduct', count: number, product: { __typename?: 'Product', _id: string, name: string } }> } & { ' $fragmentName'?: 'ProductOrderFragmentFragment' };
...
export type AddStockMutation = { __typename?: 'Mutation', addStock: Array<{ __typename?: 'Stock', _id: string }> };
