...
export type CategoryFragmentFragment = { __typename?: 'Category', _id: string, name: string } & { ' $fragmentName'?: 'CategoryFragmentFragment' };

export type UserFragmentFragment = { __typename?: 'User', id: string, role: UserRole, createdAt: any } & { ' $fragmentName'?: 'UserFragmentFragment' };

export type ProductFragmentFragment = { __typename?: 'Product', _id: string, code: string, barCode?: string | null, name: string, wonPrice: number, salePrice: number, leadTime?: number | null, maintainDate?: number | null } & { ' $fragmentName'?: 'ProductFragmentFragment' };

export type FullProductFragmentFragment = { __typename?: 'ProductOutput', _id: string, code: string, barCode?: string | null, name: string, wonPrice: number, salePrice: number, leadTime?: number | null, maintainDate?: number | null, category?: (
    { __typename?: 'Category' }
    & { ' $fragmentRefs'?: { 'CategoryFragmentFragment': CategoryFragmentFragment } }
  ) | null } & { ' $fragmentName'?: 'FullProductFragmentFragment' };
...
export type UpdateCategoryMutation = { __typename?: 'Mutation', updateCategory: { __typename?: 'Category', _id: string, name: string } };
...
export type CategoriesQuery = { __typename?: 'Query', categories: { __typename?: 'CategoriesOutput', totalCount: number, data: Array<{ __typename?: 'Category', _id: string, name: string }> } };
...
export type RemoveCategoryMutation = { __typename?: 'Mutation', removeCategory: { __typename?: 'Category', _id: string, name: string } };
...
export type CreateProductMutation = { __typename?: 'Mutation', createProduct: (
    { __typename?: 'ProductOutput' }
    & { ' $fragmentRefs'?: { 'FullProductFragmentFragment': FullProductFragmentFragment } }
  ) };
...
export const FullProductFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"FullProductFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProductOutput"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"barCode"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"wonPrice"}},{"kind":"Field","name":{"kind":"Name","value":"salePrice"}},{"kind":"Field","name":{"kind":"Name","value":"leadTime"}},{"kind":"Field","name":{"kind":"Name","value":"maintainDate"}},{"kind":"Field","name":{"kind":"Name","value":"category"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"CategoryFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CategoryFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Category"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]} as unknown as DocumentNode<FullProductFragmentFragment, unknown>;
