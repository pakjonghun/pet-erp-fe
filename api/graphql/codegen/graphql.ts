...
export type Query = {
  ...
  topClients: Array<TopClientOutput>;
  user: User;
  users: Array<User>;
};
...
export type TopClientsQuery = { __typename?: 'Query', topClients: Array<{ __typename?: 'TopClientOutput', accProfit: number, accPayCost: number, accCount: number, name: string }> };
